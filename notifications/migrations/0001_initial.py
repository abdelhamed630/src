        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[
                    ...
                    ('order_cancelled','Order Cancelled'),('new_message','New Message'),
                    ('new_review','New Review'),('seller_approved','Seller Approved'),
                    ('seller_rejected','Seller Rejected'),('promo','Promotion'),
                ], max_length=30)),
